                        ...
                        <div class="col-md-6 col-lg-6 col-xl-5">
                            <div class="footer-item">
                                <a href="index.html" class="p-0">
                                    <h3 class="text-white"><span class="text-danger">Nimble</span> Solution</h3>
                        ...
                        <div class="col-12">
                            <div class="row g-4">
                                <div class="col-lg-6 col-xl-4">
                                    <div class="d-flex">
                                        <div class="btn-md-square p-1 bg-primary text-white rounded me-4">
                                            <i class="fas fa-map-marker-alt"></i>
                                        </div>
                                        <div>
                                            <h4 class="text-white">Address</h4>
                                            <p class="mb-0">Noida Sector 62, Uttar Pradesh 201309 India</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xl-4">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">info@nimblesolution.in</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xl-4">
                ...
                <div class="footer-item">
                    ...
                    <div class="d-flex flex-shrink-0">
                        ...
                        <div class="d-flex flex-column ms-3 flex-shrink-0">
                            ...
                            <a href="tel:+917462034912"><span class="text-white">Free: +91 7462034912</span></a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="container-fluid copyright py-4">
    <div class="container">
        <div class="row g-4 align-items-center">
            <span class="text-body"><a href="#" class="border-bottom text-white"><i class="fas fa-copyright text-light me-2"></i>Nimble Solution</a>, All right reserved.</span>
        </div>
    </div>
</div>
<!-- Copyright End -->